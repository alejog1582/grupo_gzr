...
<div class="wrapper-fidepuntos">
    ...
    <div class="container">
        <div class="row">
            <div class="col-10">
                <h1 class="titulo-vista">Crear Nueva Categoria</h1>
            </div>
            <div class="col-2">
        ...
        <div class="row">
            <div style="width: 100%" class="card cuerpo_tabla">
                <br>
                <div class="container">
                    <form action="/dashboard/fidepuntos/nuevacategoria/save" method="post" >
                        {{ csrf_field() }}
                        <div class="form-row">
                            ...
                            <div class="form-group col-sm-4">
                                ...
                                <input required type="text" class="form-control" id="nombre_categoria" name="nombre_categoria">
                            </div>
                            <div class="form-group col-sm-4">
